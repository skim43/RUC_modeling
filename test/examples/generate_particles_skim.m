clc; clear;
addpath('/scratch365/cswarm/skim/RUC_design/gen_PGFem3D_input_from_Rocpack/generate_layer_spherical_pack')
...
layer_thickness = 0.1;      % in [mm] 
particle_gap = 0.000;
vf0 = 0.033;                % particle fraction
r= [2.0e-2];  % particle radius size 
box = [1.0e-1, 1.0e-1, 1.0e-1];           % cell size Lx, Ly, Lz
N = [1];            % number of particles to create 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
