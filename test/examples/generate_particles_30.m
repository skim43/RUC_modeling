...
layer_thickness = 0.02;      % in [mm] 
particle_gap = 0.1;
vf0 = 0.4273;                % particle fraction
r= [0.1045, 0.1294, 0.1544, 0.1793];  % particle radius size 
box = [1.0677, 1.0677, 1.0677];           % cell size Lx, Ly, Lz
N = [2, 16, 19, 3];            % number of particles to create 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if(generate_new_particles)
  ...
  cmd = ['module load gcc; /afs/crc.nd.edu/group/cswarm/bin/pack-4-8-0-SHAKE -o', fn_rp, ' ', fn_in];
  fprintf('run: %s\n', cmd);
