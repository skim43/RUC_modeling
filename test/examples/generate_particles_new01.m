clc; clear;
addpath('/scratch365/cswarm/kramos/interface/generate_layer_spherical_pack')
...
layer_thickness = 0.026;      % in [mm] 
particle_gap = 0.0378;
num_prop=3;                  % number of materials  
vf0 = 0.5620;                % particle fraction
r= [112e-3, 132e-3, 153e-3, 173e-3];  % particle radius size 
box = [1122e-3, 1122e-3, 1122e-3];           % cell size Lx, Ly, Lz
N = [5, 21, 26, 8];            % number of particles to create 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if(generate_new_particles)
  ...
  get_particle_positions(fn_rp, fn_rp2t3d);
