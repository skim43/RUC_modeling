...
particle_gap = 0.01;
vf0 = 0.4507;                % particle fraction
r= [101.4e-3, 121.7e-3, 142.0e-3, 162.2e-3];  % particle radius size 
box = [563e-3, 563e-3, 563e-3];           % cell size Lx, Ly, Lz
N = [1, 3, 3, 1];            % number of particles to create 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if(generate_new_particles)
  ...
  fprintf(fid, 'boundary { box %e %e %e solid}\n\n', box(1), box(2), box(3));
  for i=1:length(r)
