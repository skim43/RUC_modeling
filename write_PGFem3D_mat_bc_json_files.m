function write_PGFem3D_mat_bc_json_files(filename_base, BC, Mat, initial_disp, density)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% write_PGFem3D_mat_bc_json_files(filename_base, BC, Mat, initial_disp, density)
%
% write PGFem3D input file for material and boundary condition
% input:
